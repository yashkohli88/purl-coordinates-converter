...
const supportedPurlTypes = ['composer']
const supportedTypeProviderPairs = ['composer:packagist']
...
export function toPurl(c: CoordinatesSpec): PackageURL {
  return new PackageURL('composer', c.namespace === '-' ? null : c.namespace, c.name, c.revision, null, null)
}
